...
import { storage, sessionStore } from "./storage.mysql";
import { User } from "../shared/schema.mysql";
...
export function setupAuth(app: Express) {
  // Use the centralized session store from storage module which handles both MySQL and memory fallback
